...
const state = {
  ...
  categories: [
    ...
    { name:'3x3 Femenil A',        img:'assets/3x3Fem.jpeg',                teams:[], jornadas:[], standings:[], players:{}, attendance:{}, attJornadas:{} },
    { name:'3x3 Varonil Miércoles',img:'assets/magnoliga-categorias.jpg',   teams:[], jornadas:[], standings:[], players:{}, attendance:{}, attJornadas:{} },
    { name:'3x3 Varonil Jueves',   img:'assets/magnoliga-categorias.jpg',   teams:[], jornadas:[], standings:[], players:{}, attendance:{}, attJornadas:{} },
    { name:'Mixto 3x3',            img:'assets/3x3Mixto.jpeg',              teams:[], jornadas:[], standings:[], players:{}, attendance:{}, attJornadas:{} },
    { name:'Veteranos +40 3x3',    img:'assets/3x3Vet.jpeg',                teams:[], jornadas:[], standings:[], players:{}, attendance:{}, attJornadas:{} },
    { name:'3x3 Dom. Grp A',       img:'assets/3x3DomA.jpeg',               teams:[], jornadas:[], standings:[], players:{}, attendance:{}, attJornadas:{} },
    { name:'3x3 Dom. Grp B',       img:'assets/3x3Dominical.jpeg',          teams:[], jornadas:[], standings:[], players:{}, attendance:{}, attJornadas:{} },
    {
